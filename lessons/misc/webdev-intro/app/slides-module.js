'use strict';
// Separate the module scope from everything else
...
// the definition of layoutListener had to be moved here so it could be exported
...
// Choose what things to expose
startSlides.nextSlide = nextSlide;
startSlides.prevSlide = prevSlide;
startSlides.layoutListener = layoutListener;
// These don't work, because while making the module, they're still undefined
startSlides.cElm = cElm;
startSlides.nElm = nElm;

// add startSlides function to `window` (the global scope in browser)

...
The TAC for the 2017 Pacific Halibut seasson was `r TAC`. From the total quota, `r Canada/1000000` million tons where allocated to Canda and `r (Alaska + USA)/1000000 ` million tons for the US (Alasaka = `r Alaska/1000000`, Mainland = `r USA/1000000`).

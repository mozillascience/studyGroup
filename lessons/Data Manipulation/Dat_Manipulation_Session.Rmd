...
### The "bind" family
These functions will help us bind two or more datasets in one deoending on different variables.

#### bind_cols

The `bind_cols` function allows us to bind two datasets by column.
...
**NOTE:** for Mac users the pipe simbol "%>%" shortcut is: command + shit + m. For windows users is: Ctrol + Shift + m

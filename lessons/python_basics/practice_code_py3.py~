...
#Print is a intelligent, and we can pass it all sorts of weird 
#things.
...
#numpy library.  Here, "try/except" means try <try code>, and 
#if Python throws up an exception, do <except code>.
...
#also returns a value (to return multiple values, you can use lists).

#Mutable types passed as an argument into a function can't be changed 
#by the function:

...
1. **Session Matterials:** Go to the [repository](https://github.com/jepa/studyGroup/tree/gh-pages/lessons/Intro_Map) and click on the "fork" button to create an independent copy within your own GitHub account. Alternately, click on the "clone or download" button. 

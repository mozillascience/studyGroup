...
author: Ahmed Hasan and James Santangelo
output: pdf_document
---
...
Fortunately for us, the `dplyr` package allows us to perform this operation in
a similarly straightforward manner, and works quite nicely with `ggplot2` to
boot. Let's have a look:
...
function, but that is a bit outside of the scope of this lesson for now.
